...
const SELF_CLOSING_ACTION_PATTERN = /<(?:delete_file|delete|read_file|read|list_files|list_dir|ls|list_mcp_tools|call:delete_file|call:delete|call:read_file|call:read|call:list_files|call:list_dir|call:ls|call:list_mcp_tools)\b[^>]*\/?>/gi;
